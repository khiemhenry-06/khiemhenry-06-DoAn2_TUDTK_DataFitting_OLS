...
\begin{tabular}{p{3.1cm}p{4.8cm}p{3.2cm}p{3.6cm}}
\rowcolor{reportblue}
\tableheader{Thuộc tính} & \tableheader{Ý nghĩa} & \tableheader{Vai trò} & \tableheader{Cách xử lý} \\
\midrule
\texttt{Name} & Tên trò chơi & Định danh quan sát & Không dùng trực tiếp trong mô hình \\
\texttt{Platform} & Nền tảng phát hành game & Biến phân loại đầu vào & Điền \texttt{Unknown}, one-hot encoding \\
\texttt{Year\_of\_Release} & Năm phát hành & Biến thời gian & Không dùng trong pipeline chính do thiếu dữ liệu và cần xử lý riêng \\
\texttt{Genre} & Thể loại game & Biến phân loại đầu vào & Điền \texttt{Unknown}, one-hot encoding \\
\texttt{Publisher} & Nhà phát hành & Biến phân loại đầu vào & Giữ top publisher, nhóm còn lại thành \texttt{Other} \\
\texttt{Critic\_Score} & Điểm đánh giá của chuyên gia & Biến số đầu vào & Chuyển numeric, điền median, chuẩn hóa z-score \\
\texttt{Critic\_Count} & Số lượt đánh giá của chuyên gia & Biến số đầu vào & Điền median, chuẩn hóa z-score \\
\texttt{User\_Score} & Điểm đánh giá của người dùng & Biến số đầu vào & Chuyển \texttt{tbd} thành missing, điền median, chuẩn hóa \\
\texttt{User\_Count} & Số lượt đánh giá của người dùng & Biến số đầu vào & Điền median, chuẩn hóa z-score \\
\texttt{Developer}, \texttt{Rating} & Nhà phát triển và phân loại độ tuổi & Biến mô tả bổ sung & Không dùng trong pipeline chính để giữ mô hình gọn và ổn định \\
\texttt{NA\_Sales}, \texttt{EU\_Sales}, \texttt{JP\_Sales}, \texttt{Other\_Sales} & Doanh thu theo khu vực & Biến gây rò rỉ dữ liệu & Loại bỏ khỏi ma trận đặc trưng \\
\texttt{Global\_Sales} & Tổng doanh thu toàn cầu & Biến mục tiêu & Dùng làm $y$ trong bài toán hồi quy \\
\bottomrule
\end{tabular}
\end{table}
